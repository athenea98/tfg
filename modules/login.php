  ...
  <div class="row">
     ...
     <div class="col-lg-6">
      <h3 class="text-center">Alumno</h3>
		<?php if(isset($_GET['student'])) : ?>
				...
				<div class="form-group alert alert-dismissible alert-danger">
					<button type="button" class="close" data-dismiss="alert">×</button>
					<strong>Error</strong> Número inválido
				</div>
    ...
    <div class="col-md-8 col-md-offset-3 col-lg-8">
      <form class="form-horizontal" action="index.php" method="post" id="studentForm" data-toggle="validator">
        <div class="form-group">
          <label for="rollno" class="control-label">Número id</label>
          <input type="number" class="form-control" id="rollno" maxlength="6" name="rollno"  required>
        </div>
